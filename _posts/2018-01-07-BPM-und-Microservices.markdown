...
Der Unterschied liegt darin das beim rBPM das BPM System die Prozesse nachgelagert nach dem Ablauf ständig analysiert und falls möglich mit einem SOLL/PLAN Model vergleicht. BPM ist nicht führend bei der Prozesssteuerung sondern dafür sind die jeweiligen beteiligten Fachapplikationen allein zuständig. Damit steuert der rBPM nur indirekt das Prozessablauf.
